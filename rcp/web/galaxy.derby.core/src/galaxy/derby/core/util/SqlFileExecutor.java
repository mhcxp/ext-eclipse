package galaxy.derby.core.util;

import galaxy.derby.core.DerbyActivator;
...
public class SqlFileExecutor {
	...
	private static List<String> loadSql(String sqlFile) throws Exception {
		...
		try {
			...
			InputStream sqlFileIn = FileLocator.openStream(DerbyActivator
					.getContext().getBundle(), new Path(sqlFile), false);
