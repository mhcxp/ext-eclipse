...
Ext.DomHelper = function() {
	var w = null, k = /^(?:br|frame|hr|img|input|link|meta|range|spacer|wbr|area|param|col)$/i, m = /^table|tbody|tr|td$/i, d = /tag|children|cn|html$/i, s = /td|tr|tbody/i, o = /([a-z0-9-]+)\s*:\s*([^;\s]+(?:\s*[^;\s]+)*);?/gi, u = /end/i, r, n = "afterbegin", p = "afterend", c = "beforebegin", q = "beforeend", a = "<table>", i = "</table>", b = a
			+ "<tbody>", j = "</tbody>" + i, l = b + "<tr>", v = "</tr>" + j;
	...
	r = {
		...
		insertHtml : function(C, x, D) {
			...
			if (x.insertAdjacentHTML) {
				if (m.test(x.tagName)
						&& (y = e(x.tagName.toLowerCase(), C, x, D))) {
					return y
				}
					...
					compile : function() {
						...
						if (Ext.isGecko) {
							body = "this.compiled = function(values){ return '"
									+ me.html.replace(me.compileARe, "\\\\")
											.replace(me.compileBRe, "\\n")
											.replace(me.compileCRe, "\\'")
											.replace(me.re, fn) + "';};"
						} else {
							body = [ "this.compiled = function(values){ return ['" ];
							body.push(me.html.replace(me.compileARe, "\\\\")
									.replace(me.compileBRe, "\\n").replace(
											me.compileCRe, "\\'").replace(
											me.re, fn));
							body.push("'].join('');};");
							body = body.join("")
						}
...
(function() {
			...
			if (typeof m == "object") {
				...
				for (n in l) {
					...
					if (!p.filterOptRe.test(n)) {
						p.addListener(n, t.fn || t, t.scope || l.scope,
								t.fn ? t : l)
					}
				}
			} else {
	...
	function a(n, p, k, m) {
		return function() {
			...
			k.tasks.push(l);
			l.delay(p.delay || 10, n, m, Array.prototype.slice.call(arguments,
					0))
		}
	}
				...
				function() {
					...
					return {
						...
						enableBubble : function(e) {
							var g = this;
							if (!Ext.isEmpty(e)) {
								e = Ext.isArray(e) ? e : Array.prototype.slice
										.call(arguments, 0);
								for ( var d = 0, b = e.length; d < b; d++) {
									var c = e[d];
									c = c.toLowerCase();
...
Ext
		.apply(
				Ext.EventManager,
				function() {
					var c, j, e, b, a = Ext.lib.Dom, i = /^(?:scope|delay|buffer|single|stopEvent|preventDefault|stopPropagation|normalized|args|delegate)$/, h = 0, g = 0, d = Ext.isWebKit ? Ext
					...
					return {
						...
						onTextResize : function(n, m, k) {
							if (!e) {
								...
								var l = new Ext.Element(document
										.createElement("div"));
...
(function() {
	...
	h.prototype = {
		...
		contains : function(o) {
			return !o ? false : Ext.lib.Dom.isAncestor(this.dom, o.dom ? o.dom
					: o)
		},
...
Ext.apply(Ext.Element.prototype, function() {
	...
	return {
		insertSibling : function(i, g, h) {
			...
			i = i || {};
			if (i.nodeType || i.dom) {
				e = j.dom.parentNode.insertBefore(c(i), d ? j.dom.nextSibling
						: j.dom);
				if (!h) {
					e = a(e)
				}
...
Ext.Element
		.addMethods(function() {
			var i = {}, z = /(-[a-z])/gi, c = {}, t = document.defaultView, w = Ext.isIE ? "styleFloat"
					: "cssFloat", E = /alpha\(opacity=(.*)\)/i, m = /^\s+|\s+$/g, v = /\s+/, b = /\w/g, C = Ext.Element, e = "padding", d = "margin", A = "border", u = "-left", r = "-right", y = "-top", p = "-bottom", k = "-width", s = Math, B = "hidden", g = "isClipped", l = "overflow", o = "overflow-x", n = "overflow-y", D = "originalClip", j = {
				l : A + u + k,
				r : A + r + k,
				t : A + y + k,
				b : A + p + k
			...
			return {
				...
				toggleClass : function(G) {
					return this.hasClass(G) ? this.removeClass(G) : this
							.addClass(G)
				},
				hasClass : function(G) {
					return G
							&& (" " + this.dom.className + " ").indexOf(" " + G
									+ " ") != -1
				},
				...
				getStyle : function() {
					return t && t.getComputedStyle ? function(M) {
						...
						H = (G = J.style[M]) ? G : (I = t.getComputedStyle(J,
								"")) ? I[M] : null;
						if (L) {
							if (H == "rgba(0, 0, 0, 0)") {
								H = "transparent"
						...
						K = x(K);
						return I.style[K]
								|| ((H = I.currentStyle) ? H[K] : null)
					}
				}(),
				getColor : function(G, H, L) {
					var J = this.getStyle(G), I = (typeof L != "undefined") ? L
							: "#", K;
					if (!J || /transparent|inherit/.test(J)) {
						return H
					}
					if (/^r/.test(J)) {
						Ext.each(J.slice(4, J.length - 1).split(","), function(
								M) {
							K = parseInt(M, 10);
				...
				setStyle : function(K, J) {
					...
					for (I in K) {
						J = K[I];
						I == "opacity" ? this.setOpacity(J)
								: this.dom.style[x(I)] = J
					}
					return this
				},
				...
				getHeight : function(I) {
					var H = this, K = H.dom, J = Ext.isIE
							&& H.isStyle("display", "none"), G = s.max(
							K.offsetHeight, J ? 0 : K.clientHeight) || 0;
					G = !I ? G : G - H.getBorderWidth("tb")
							- H.getPadding("tb");
					return G < 0 ? 0 : G
				},
				getWidth : function(H) {
					var I = this, K = I.dom, J = Ext.isIE
							&& I.isStyle("display", "none"), G = s.max(
							K.offsetWidth, J ? 0 : K.clientWidth) || 0;
					G = !H ? G : G - I.getBorderWidth("lr")
							- I.getPadding("lr");
					return G < 0 ? 0 : G
				},
				...
				setHeight : function(G, H) {
					var I = this;
					G = I.adjustHeight(G);
					!H || !I.anim ? I.dom.style.height = I.addUnits(G) : I
							.anim({
								height : {
									to : G
								}
...
(function() {
	...
	Ext.Element.addMethods({
		...
		setX : function(l, m) {
			return this.setXY([ l, this.getY() ], this
					.animTest(arguments, m, 1))
		},
		setY : function(m, l) {
			return this.setXY([ this.getX(), m ], this
					.animTest(arguments, l, 1))
		},
		setLeft : function(l) {
...
Ext.Element
		.addMethods(function() {
			var h = "visibility", d = "display", b = "hidden", k = "offsets", j = "none", a = "originalDisplay", c = "visibilityMode", e = Ext.Element.DISPLAY, g = Ext.Element.data, i = function(
					n) {
				var m = g(n, a);
				if (m === undefined) {
					g(n, a, m = "")
		...
		.addMethods(function() {
			...
			return {
				...
				mask : function(j, n) {
					...
					if (!/^body/i.test(l.tagName)
							&& p.getStyle("position") == "static") {
						p.addClass(g)
					}
					if ((i = e(l, "maskMsg"))) {
						i.remove()
			...
			.extend(
					...
					Ext.util.Observable,
					{
						...
						request : function(n) {
							...
							if (s.fireEvent(b, s, n)) {
								if (n.el) {
									...
									n.success = (Ext.isFunction(n.success) ? n.success
											: function() {
											})
								...
								l = Ext.urlEncode(s.extraParams, Ext
										.isObject(l) ? Ext.urlEncode(l) : l);
								if (Ext.isFunction(k)) {
								...
								j = n.method
										|| s.method
										|| ((l || n.xmlData || n.jsonData) ? i
												: a);
								if (j === a
										&& (s.disableCaching && n.disableCaching !== false)
										|| n.disableCaching === true) {
									var r = n.disableCachingParam
											|| s.disableCachingParam;
									k = Ext.urlAppend(k, r + "="
											+ (new Date().getTime()))
								}
								...
								return (s.transId = Ext.lib.Ajax.request(j, k,
										q, l, n))
							} else {
								return n.callback ? n.callback.apply(n.scope, [
										n, h, h ]) : null
							}
						},
						isLoading : function(j) {
							return j ? Ext.lib.Ajax.isCallInProgress(j)
									: !!this.transId
						},
						abort : function(j) {
							if (j || this.isLoading()) {
						...
						doFormUpload : function(q, j, k) {
							var l = Ext.id(), v = document, r = v
									.createElement("iframe"), m = Ext
					...
					applySubTemplate : function(a, k, j, d, c) {
						...
						if (m.target && Ext.isArray(l)) {
							for ( var e = 0, g = l.length; e < g; e++) {
								b[b.length] = m.compiled.call(h, l[e], j,
										e + 1, g)
							}
							return b.join("")
						}
		...
		.extend(
				Ext.layout.ContainerLayout,
				{
					...
					onLayout : function(m, p) {
						Ext.layout.AnchorLayout.superclass.onLayout.call(this,
								m, p);
						...
						for (j = 0; j < n; j++) {
							q = o[j];
							e = q.getPositionEl();
							if (!q.anchor && q.items && !Ext.isNumber(q.width)
							...
							if (q.anchor) {
								...
								if (!s) {
									u = q.anchor.split(" ");
									q.anchorSpec = s = {
										right : this.parseAnchor(u[0],
												q.initialConfig.width, d),
										bottom : this.parseAnchor(u[1],
												q.initialConfig.height, r)
									}
								}
								g = s.right ? this.adjustWidthAnchor(s.right(t)
										- e.getMargins("lr"), q) : undefined;
								b = s.bottom ? this.adjustHeightAnchor(s
										.bottom(l)
										- e.getMargins("tb"), q) : undefined;
								if (g || b) {
									k.push({
										comp : q,
										width : g || undefined,
...
Ext.layout.ColumnLayout = Ext.extend(Ext.layout.ContainerLayout, {
	...
	renderAll : function(a, b) {
		...
		Ext.layout.ColumnLayout.superclass.renderAll
				.call(this, a, this.innerCt)
	},
		...
		.extend(
				Ext.layout.ContainerLayout,
				{
					...
					onLayout : function(g, I) {
						...
						if (B = I.getStyle("overflow") && B != "hidden"
								&& !this.adjustmentPass) {
...
Ext.layout.AccordionLayout = Ext
		.extend(
				Ext.layout.FitLayout,
				{
					...
					renderItem : function(a) {
						...
						Ext.layout.AccordionLayout.superclass.renderItem.apply(
								this, arguments);
						a.header.addClass("x-accordion-hd");
						a.on("beforeexpand", this.beforeExpand, this)
					},
					onRemove : function(a) {
						Ext.layout.AccordionLayout.superclass.onRemove.call(
								this, a);
						if (a.rendered) {
					...
					setItemSize : function(g, e) {
						if (this.fill && g) {
							var d = 0, c, b = this
									.getRenderedItems(this.container), a = b.length, h;
							for (c = 0; c < a; c++) {
								if ((h = b[c]) != g && !h.hidden) {
...
Ext.layout.BoxLayout = Ext
		.extend(
				Ext.layout.ContainerLayout,
				{
					...
					constructor : function(a) {
						Ext.layout.BoxLayout.superclass.constructor.call(this,
								a);
					...
					onLayout : function(a, d) {
						Ext.layout.BoxLayout.superclass.onLayout.call(this, a,
								d);
						var b = this.getVisibleItems(a), c = this
								.getLayoutTargetSize();
		...
		.extend(
				Ext.layout.BoxLayout,
				{
					...
					updateInnerCtSize : function(b, d) {
						var c = b.height, a = d.meta.maxWidth
					...
					calculateChildBoxes : function(w, e) {
						var k = w.length, u = this.padding, y = u.top, p = u.left, q = y
								+ u.bottom, a = p + u.right, x = e.width
								- this.scrollOffset, v = e.height, A = Math
								.max(0, x - a), l = this.pack == "start", m = this.pack == "center", n = this.pack == "end", I = 0, E = 0, z = 0, j = [], h, d, g, b, t, C, B, s, F, G, D;
						for (B = 0; B < k; B++) {
							h = w[B];
							g = h.height;
							d = h.width;
						...
						for (B = 0; B < k; B++) {
							...
							case "stretch":
								D = A - G;
								s.width = D.constrain(h.minWidth || 0,
										h.maxWidth || 1000000);
								s.dirtySize = true;
								break;
							case "stretchmax":
...
Ext.layout.HBoxLayout = Ext
		.extend(
				Ext.layout.BoxLayout,
				{
					...
					type : "hbox",
					updateInnerCtSize : function(b, d) {
						var a = b.width, c = d.meta.maxHeight
					...
					calculateChildBoxes : function(z, e) {
						var n = z.length, x = this.padding, C = x.top, r = x.left, s = C
								+ x.bottom, a = r + x.right, B = e.width
								- this.scrollOffset, y = e.height, h = Math
								.max(0, y - s), o = this.pack == "start", p = this.pack == "center", q = this.pack == "end", I = 0, A = 0, D = 0, m = [], l, d, g, c, w, F, E, v, H, j, t;
						for (E = 0; E < n; E++) {
							l = z[E];
							g = l.height;
							d = l.width;
						...
						for (E = 0; E < n; E++) {
							...
							case "stretch":
								t = h - j;
								v.height = t.constrain(l.minHeight || 0,
										l.maxHeight || 1000000);
								v.dirtySize = true;
								break;
							case "stretchmax":
		...
		.extend(
				Ext.layout.ContainerLayout,
				{
					...
					onLayout : function(e, j) {
						if (!this.leftTr) {
							var h = e.buttonAlign == "center" ? "center"
									: "left";
							j.addClass("x-toolbar-layout-ct");
							j.insertHtml("beforeEnd", String.format(
									this.tableHTML, h));
							this.leftTr = j
									.child("tr.x-toolbar-left-row", true);
							this.rightTr = j.child("tr.x-toolbar-right-row",
									true);
							this.extrasTr = j.child("tr.x-toolbar-extras-row",
									true);
							if (this.hiddenItem == undefined) {
								this.hiddenItems = []
							}
						}
						var k = e.buttonAlign == "right" ? this.rightTr
								: this.leftTr, l = e.items.items, d = 0;
					...
					createMenuConfig : function(c, a) {
						...
						Ext.copyTo(b, c, [ "iconCls", "icon", "itemId",
...
Ext.layout.MenuLayout = Ext
		.extend(
				Ext.layout.ContainerLayout,
				{
					...
					onLayout : function(a, b) {
						Ext.layout.MenuLayout.superclass.onLayout.call(this, a,
								b);
						this.doAutoSize()
					},
					doAutoSize : function() {
...
Ext.Panel = Ext.extend(Ext.Container, {
	...
	initDraggable : function() {
		this.dd = new Ext.Panel.DD(this, Ext.isBoolean(this.draggable) ? null
				: this.draggable)
	},
	...
	createGhost : function(a, e, b) {
		...
		Ext.fly(d.appendChild(document.createElement("ul"))).setHeight(
				...
				Ext.Component,
				{
					...
					select : function(b, a) {
						...
						if (b != this.value || this.allowReselect) {
							var c = this.el;
							if (this.value) {
								c.child("a.color-" + this.value).removeClass(
										"x-color-palette-sel")
							}
							c.child("a.color-" + b).addClass(
									"x-color-palette-sel");
							this.value = b;
							if (a !== true) {
					...
					update : function(G, A) {
						if (this.rendered) {
							...
							var B = G.add("mo", -1), h = B.getDaysInMonth() - g, e = this.cells.elements, r = this.textNodes, D = (new Date(
									B.getFullYear(), B.getMonth(), h,
									this.initHour)), C = new Date().clearTime()
									.getTime(), v = G.clearTime(true).getTime(), u = this.minDate ? this.minDate
									.clearTime(true)
									: Number.NEGATIVE_INFINITY, y = this.maxDate ? this.maxDate
									.clearTime(true)
									: Number.POSITIVE_INFINITY, F = this.disabledDatesRE, s = this.disabledDatesText, I = this.disabledDays ? this.disabledDays
									.join("")
		...
		.extend(
				Ext.BoxComponent,
				{
					...
					initComponent : function() {
						...
						this.thumbs = [];
						Ext.slider.MultiSlider.superclass.initComponent
								.call(this);
					...
					onRender : function() {
						...
						Ext.slider.MultiSlider.superclass.onRender.apply(this,
								arguments);
						...
						this.halfThumb = (this.vertical ? a.getHeight() : a
								.getWidth()) / 2;
						this.initEvents()
					},
					initEvents : function() {
					...
					onClickChange : function(c) {
						if (c.top > this.clickRange[0]
								&& c.top < this.clickRange[1]) {
							var a = this.getNearest(c, "left"), b = a.index;
							this.setValue(b, Ext.util.Format.round(this
									.reverseValue(c.left),
									this.decimalPrecision), undefined, true)
						}
					},
					getNearest : function(k, b) {
						var m = b == "top" ? this.innerEl.getHeight() - k[b]
								: k[b], g = this.reverseValue(m), j = (this.maxValue - this.minValue) + 5, e = 0, c = null;
						for ( var d = 0; d < this.thumbs.length; d++) {
							var a = this.thumbs[d], l = a.value, h = Math.abs(l
									- g);
							if (Math.abs(h <= j)) {
								c = a;
								e = d;
					...
					afterRender : function() {
						Ext.slider.MultiSlider.superclass.afterRender.apply(
								this, arguments);
						for ( var c = 0; c < this.thumbs.length; c++) {
							...
							if (b.value !== undefined) {
								...
								if (a !== b.value) {
									...
									this.moveThumb(c, this.translateValue(a),
											false)
								}
							}
						}
					...
					setValue : function(d, c, b, g) {
						...
						if (c !== a.value
								&& this.fireEvent("beforechange", this, c,
										a.value, a) !== false) {
							a.value = c;
							if (this.rendered) {
								this.moveThumb(d, this.translateValue(c),
										b !== false);
								this.fireEvent("change", this, c, a);
								if (g) {
									this
											.fireEvent("changecomplete", this,
													c, a)
								}
							}
						}
					...
					onResize : function(c, e) {
						...
						this.innerEl.setWidth(c
								- (this.el.getPadding("l") + this.endEl
										.getPadding("r")));
						this.syncThumb();
						Ext.slider.MultiSlider.superclass.onResize.apply(this,
								arguments)
					},
					onDisable : function() {
					...
					syncThumb : function() {
						if (this.rendered) {
							for ( var a = 0; a < this.thumbs.length; a++) {
								this.moveThumb(a, this
										.translateValue(this.thumbs[a].value))
							}
						}
					},
					getValue : function(a) {
					...
					beforeDestroy : function() {
						Ext.destroyMembers(this, "endEl", "innerEl", "thumb",
								...
								"thumbHolder");
						Ext.slider.MultiSlider.superclass.beforeDestroy
								.call(this)
					}
				});
...
Ext.slider.SingleSlider = Ext.extend(Ext.slider.MultiSlider, {
	...
	syncThumb : function() {
		return Ext.slider.SingleSlider.superclass.syncThumb.apply(this, [ 0 ]
				.concat(arguments))
	},
	getNearest : function() {
		...
		.extend(
				Ext.util.Observable,
				{
					...
					constructor : function(a) {
						...
						this.modified = [];
						this.addEvents("datachanged", "metachange", "add",
								"remove", "update", "clear", "exception",
					...
					buildWriter : function(b) {
						var a = undefined, c = (b.format || "json")
								.toLowerCase();
						switch (c) {
						case "json":
					...
					execute : function(e, a, c, b) {
						...
						if (e === "read") {
							...
							if ((d = this.fireEvent("beforewrite", this, e, a,
									c)) !== false) {
								this.writer.apply(c.params, this.baseParams, e,
										a)
							}
						}
						if (d !== false) {
							if (this.writer
									...
									&& !this.proxy.restful
									&& !Ext.data.Api
											.hasUniqueUrl(this.proxy, e)) {
								c.params.xaction = e
							}
							this.proxy.request(Ext.data.Api.actions[e], a,
									c.params, this.reader, this.createCallback(
											e, a, b), this, c)
						}
						return d
					},
					...
					createCallback : function(c, a, b) {
						...
						return (c == "read") ? this.loadRecords : function(g,
								e, h) {
							this["on" + Ext.util.Format.capitalize(c)
									+ "Records"](h, a, [].concat(g));
							if (h === true) {
					...
					clearModified : function(a) {
						if (Ext.isArray(a)) {
							for ( var b = a.length - 1; b >= 0; b--) {
								this.modified.splice(this.modified
										.indexOf(a[b]), 1)
							}
						} else {
					...
					onDestroyRecords : function(e, b, d) {
						b = (b instanceof Ext.data.Record) ? [ b ] : []
								.concat(b);
						for ( var c = 0, a = b.length; c < a; c++) {
					...
					loadRecords : function(h, b, g) {
						...
						if (!b || b.add !== true) {
							...
							this.totalLength = Math.max(d, this.data.length
									+ e.length);
							this.add(e)
						}
					...
					applySort : function() {
						if ((this.sortInfo || this.multiSortInfo)
								&& !this.remoteSort) {
							this.sortData()
						}
					},
					sortData : function() {
						var a = this.hasMultiSort ? this.multiSortInfo
								: this.sortInfo, k = a.direction || "ASC", h = a.sorters, c = [];
						...
						for ( var d = 0, b = h.length; d < b; d++) {
							c.push(this.createSortFunction(h[d].field,
									h[d].direction))
						}
						if (c.length == 0) {
							return
					...
					singleSort : function(g, c) {
						...
						var b = e.name, a = this.sortInfo || null, d = this.sortToggle ? this.sortToggle[b]
								: null;
						if (!c) {
							if (a && a.field == b) {
								c = (this.sortToggle[b] || "ASC").toggle("ASC",
										"DESC")
							} else {
								c = e.sortDir
							}
					...
					multiSort : function(b, a) {
						...
						if (this.multiSortInfo
								&& a == this.multiSortInfo.direction) {
							a = a.toggle("ASC", "DESC")
						}
						this.multiSortInfo = {
							sorters : b,
					...
					filter : function(n, m, h, k, e) {
						...
						if (Ext.isArray(n)) {
							...
							for ( var g = 0, d = n.length; g < d; g++) {
								...
								if (!Ext.isFunction(c)) {
									c = this.createFilterFn(a.property,
											a.value, a.anyMatch,
		...
		INT : {
			convert : function(b) {
				return b !== undefined && b !== null && b !== "" ? parseInt(
						String(b).replace(Ext.data.Types.stripRe, ""), 10) : 0
			},
			sortType : a.none,
			type : "int"
		},
		...
		.extend(
				Ext.data.JsonReader,
				{
					readRecords : function(r) {
						this.arrayData = r;
						var l = this.meta, d = l ? Ext.num(l.idIndex, l.id)
								: null, b = this.recordType, q = b.prototype.fields, z = [], e = true, g;
						var u = this.getRoot(r);
						for ( var y = 0, A = u.length; y < A; y++) {
							var t = u[y], a = {}, p = ((d || d === 0)
									&& t[d] !== undefined && t[d] !== "" ? t[d]
									: null);
		...
		.extend(
				Ext.data.Store,
				{
					constructor : function(d) {
						...
						var e = this.multiSortInfo.sorters, c = d.groupField
								|| this.groupField, b = d.sortInfo
								|| this.sortInfo, a = d.groupDir
								|| this.groupDir;
						if (c) {
							e.push({
								field : c,
					...
					groupBy : function(d, a, c) {
						...
						if (sorters.length > 0
								&& sorters[0].field == this.groupField) {
							sorters.shift()
						}
						this.groupField = d;
						this.groupDir = c;
						this.applyGroupField();
						var b = function() {
							this.fireEvent("groupchange", this, this
									.getGroupState())
						};
						if (this.groupOnSort) {
							this.sort(d, c);
					...
					sort : function(h, c) {
						if (this.remoteSort) {
							return Ext.data.GroupingStore.superclass.sort.call(
									this, h, c)
						}
						var g = [];
						if (Ext.isArray(arguments[0])) {
										...
										Ext
												.apply(
														b,
														{
															...
															reader : (!Ext
																	.isDefined(b.reader) && b.fields) ? new Ext.data.JsonReader(
																	Ext
																			.copyTo(
																					{},
																					b,
				...
				Ext.util.Observable,
				{
					constructor : function(d, e) {
						...
						if (e && e.wrap) {
							...
							this.el = this.el
									.wrap(typeof e.wrap == "object" ? e.wrap
											: {
												cls : "xresizable-wrap"
											});
							this.el.id = this.el.dom.id = e.resizeChild.id
									+ "-rzwrap";
							this.el.setStyle("overflow", "hidden");
							this.el.setPositioning(e.resizeChild
									.getPositioning());
						...
						for ( var j = 0, l = o.length; j < l; j++) {
							if (o[j] && c[o[j]]) {
								...
								this[n] = new Ext.Resizable.Handle(this, n,
										...
										this.transparent, this.handleCls)
							}
						}
						this.corner = this.southeast;
						if (this.handles.indexOf("n") != -1
								|| this.handles.indexOf("w") != -1) {
							this.updateBox = true
						}
						this.activeHandle = null;
						if (this.resizeChild) {
							if (typeof this.resizeChild == "boolean") {
								this.resizeChild = Ext.get(
										this.el.dom.firstChild, true)
							} else {
								this.resizeChild = Ext.get(this.resizeChild,
										true)
							}
						}
						if (this.adjustments == "auto") {
							...
							this.adjustments = [
									(h ? -h.el.getWidth() : 0)
											+ (m ? -m.el.getWidth() : 0),
									(a ? -a.el.getHeight() : 0)
											+ (o ? -o.el.getHeight() : 0) - 1 ]
						}
						if (this.draggable) {
							this.dd = this.dynamic ? this.el.initDD(null)
									: this.el.initDDProxy(null, {
										dragElId : this.proxy.id
									});
							this.dd
									.setHandleElId(this.resizeChild ? this.resizeChild.id
											: this.el.id);
							if (this.constrainTo) {
...
Ext.Window = Ext.extend(Ext.Panel, {
	...
	focus : function() {
		...
		if (Ext.isDefined(a)) {
			...
			if (d && b) {
				if (!Ext.lib.Region.getRegion(b).contains(
						Ext.lib.Region.getRegion(d.dom))) {
					return
				}
			}
		}
...
Ext.MessageBox = function() {
	var u, b, q, t, h, l, s, a, n, p, j, g, r, v, o, i = "", d = "", m = [
			"ok", "yes", "no", "cancel" ];
	var c = function(x) {
		r[x].blur();
		if (u.isVisible()) {
	...
	return {
		...
		updateText : function(A) {
			...
			x = Math.max(Math.min(b.width || y + C + z + B, b.maxWidth
					|| this.maxWidth), Math.max(b.minWidth || this.minWidth,
					o || 0));
			if (b.prompt === true) {
				v.setWidth(x - y - z - B)
			}
		...
		.extend(
				Ext.util.Observable,
				{
					...
					handleHdMove : function(j, g) {
						var b = 5, a = j.getPageX(), i = j.getTarget("em", 3,
								true);
						if (i) {
					...
					onEnd : function(m) {
						...
						this.proxy.remove();
						var j = this.hdIndex, o = this.view, h = o.columns, l = h.length, q = this.view.innerHd
								.getWidth(), g = this.minPct * 100, r = Math
								.ceil((k * o.maxWidth) / q), p = (h[j].width * 100)
								- r, a = Math.floor(p / (l - 1 - j)), n = p
								- (a * (l - 1 - j));
						for ( var d = j + 1; d < l; d++) {
		...
		.extend(
				Ext.Panel,
				{
					...
					findTargets : function(c) {
						var b = null, a = c.getTarget("li:not(.x-tab-edge)",
								this.strip);
						if (a) {
							b = this
					...
					onWheel : function(g) {
						...
						g.stopEvent();
						var i = this.getScrollPos(), c = i + h, a = this
								.getScrollWidth()
								- this.getScrollArea();
...
Ext.History = (function() {
	...
	function i(m) {
		var l = [ '<html><body><div id="state">',
				Ext.util.Format.htmlEncode(m), "</div></body></html>" ]
				.join("");
		try {
					...
					getTargetXY : function() {
						...
						if (this.anchor) {
							...
							var c = this.getOffsets(), l = (this.anchorToTarget && !this.trackMouse) ? this.el
									...
									.getViewWidth() - 5, h = Ext.lib.Dom
									.getViewHeight() - 5, i = document.documentElement, e = document.body, k = (i.scrollLeft
									|| e.scrollLeft || 0) + 5, j = (i.scrollTop
									|| e.scrollTop || 0) + 5, b = [
									l[0] + c[0], l[1] + c[1] ], g = this
									.getSize();
...
Ext.tree.DefaultSelectionModel = Ext
		.extend(
				Ext.util.Observable,
				{
					constructor : function(a) {
						...
						Ext.apply(this, a);
						Ext.tree.DefaultSelectionModel.superclass.constructor
								.call(this)
					},
					init : function(a) {
						this.tree = a;
...
Ext.tree.TreeNodeUI.prototype = {
	...
	renderElements : function(e, k, j, l) {
		this.indentMarkup = e.parentNode ? e.parentNode.ui.getChildIndent()
				: "";
		var g = Ext.isBoolean(k.checked), b, c = k.href ? k.href
				: Ext.isGecko ? "" : "#", d = [
		...
		.extend(
				...
				Ext.util.Observable,
				{
					...
					requestData : function(c, d, b) {
						if (this.fireEvent("beforeload", this, c, d) !== false) {
							if (this.directFn) {
								...
								a.push(this.processDirectResponse
										.createDelegate(this, [ {
											callback : d,
											node : c,
											scope : b
					...
					handleFailure : function(c) {
						...
						this.runCallback(b.callback, b.scope || b.node,
								[ b.node ])
					},
					destroy : function() {
						this.abort();
		...
		.extend(Ext.menu.Item,
				{
					...
					setChecked : function(b, a) {
						var c = a === true;
						if (this.checked != b
								&& (c || this.fireEvent("beforecheckchange",
										this, b) !== false)) {
							if (this.container) {
		...
		.extend(
				Ext.form.Field,
				{
					...
					getErrors : function(a) {
						var d = Ext.form.TextField.superclass.getErrors.apply(
								this, arguments);
						...
						if (!this.allowBlank
								&& (a.length < 1 || a === this.emptyText)) {
							d.push(this.blankText)
						}
						if (a.length < this.minLength) {
							d.push(String.format(this.minLengthText,
									this.minLength))
						}
						if (a.length > this.maxLength) {
							d.push(String.format(this.maxLengthText,
									this.maxLength))
						}
						if (this.vtype) {
...
Ext.form.NumberField = Ext.extend(Ext.form.TextField, {
	...
	getErrors : function(b) {
		var c = Ext.form.NumberField.superclass.getErrors
				...
				Ext.form.TriggerField,
				{
					...
					getErrors : function(e) {
						...
						if (this.minValue && g < this.minValue.getTime()) {
							h.push(String.format(this.minText, this
									.formatDate(this.minValue)))
						}
						if (this.maxValue && g > this.maxValue.getTime()) {
							h.push(String.format(this.maxText, this
		...
		.extend(
				Ext.form.TriggerField,
				{
					...
					getParentZIndex : function() {
						...
						if (this.ownerCt) {
							this.findParentBy(function(b) {
								a = parseInt(b.getPositionEl().getStyle(
										"z-index"), 10);
								return !!a
							})
						}
					...
					initList : function() {
						if (!this.list) {
							var a = "x-combo-list", d = Ext.getDom(this
									.getListParent()
							...
							if (this.resizable) {
								...
								this.mon(this.resizer, "resize", function(i, e,
										g) {
					...
					expand : function() {
						...
						this.list.alignTo.apply(this.list, [ this.el ]
								.concat(this.listAlign));
						var b = Ext.getDom(this.getListParent()
								|| Ext.getBody()), a = parseInt(Ext.fly(b)
								.getStyle("z-index"), 10);
						if (!a) {
...
Ext.form.CheckboxGroup = Ext
		.extend(
				Ext.form.Field,
				{
					...
					getErrors : function() {
						var b = Ext.form.CheckboxGroup.superclass.getErrors
								.apply(this, arguments);
						if (!this.allowBlank) {
							var a = true;
				...
				this.eachItem(function(g) {
					Ext.apply(g, {
						markInvalid : this.onFieldMarkInvalid.createDelegate(
								this, [ g ], 0),
						clearInvalid : this.onFieldClearInvalid.createDelegate(
								this, [ g ], 0)
					})
				})
			}
						...
						if (!this.el) {
							...
							if (this.title || this.header
								...
								this.el.appendChild(document
										.createElement("legend")).className = this.baseCls
										+ "-header"
							}
						}
				...
				Ext.form.Field,
				{
					...
					createToolbar : function(e) {
						...
						function d(j, h, i) {
							return {
								...
								tooltip : a ? e.buttonTips[j] || undefined
										: undefined,
								overflowText : e.buttonTips[j].title
										|| undefined,
								tabIndex : -1
							}
						}
							...
							c
									.push(
											"-",
											{
												...
												clickEvent : "mousedown",
												tooltip : a ? e.buttonTips.forecolor
														|| undefined
														: undefined,
												tabIndex : -1,
											...
											},
											{
												...
												clickEvent : "mousedown",
												tooltip : a ? e.buttonTips.backcolor
														|| undefined
														: undefined,
												tabIndex : -1,
												menu : new Ext.menu.ColorMenu(
					...
					setReadOnly : function(b) {
						...
						if (this.initialized) {
							...
							if (a) {
								a.style.cursor = this.readOnly ? "default"
										: "text"
							}
							this.disableItems(b)
						}
					...
					getDocMarkup : function() {
						var a = Ext.fly(this.iframe).getHeight()
								- this.iframePad * 2;
						return String
								.format(
					...
					setDesignMode : function(b) {
						...
						if (a = this.getDoc()) {
							...
							a.designMode = (/on|true/i).test(String(b)
									.toLowerCase()) ? "on" : "off"
						}
					},
				...
				Ext.form.ComboBox,
				{
					...
					setLimit : function(b, g, a) {
						...
						if (e) {
							...
							c.setHours(e.getHours(), e.getMinutes(), e
									.getSeconds(), e.getMilliseconds());
					...
					parseDate : function(h) {
						...
						var j = this.initDate + " ", g = this.initDateFormat
								+ " ", b = Date.parseDate(j + h, g
								+ this.format), c = this.altFormats;
						if (!b && c) {
							if (!this.altFormatsArray) {
								this.altFormatsArray = c.split("|")
							}
							for ( var e = 0, d = this.altFormatsArray, a = d.length; e < a
									&& !b; e++) {
...
Ext.form.SliderField = Ext.extend(Ext.form.Field, {
	...
	initComponent : function() {
		var b = Ext.copyTo({
			id : this.id + "-slider"
		}, this.initialConfig, [ "vertical", "minValue", "maxValue",
				"decimalPrecision", "keyIncrement", "increment",
				"clickToChange", "animate" ]);
		if (this.useTips) {
			var a = this.tipText ? {
	...
	setValue : function(c, b, a) {
		...
		return Ext.form.SliderField.superclass.setValue.call(this, this.slider
				.getValue())
	},
	getValue : function() {
				...
				Ext.Panel,
				{
					...
					initComponent : function() {
						...
						this.addEvents("click", "dblclick", "contextmenu",
								...
								"sortchange", "groupchange", "reconfigure",
								"viewready")
					},
					onRender : function(d, a) {
					...
					applyState : function(a) {
						...
						if (k) {
							m = a.sort;
							if (m) {
								k[k.remoteSort ? "setDefaultSort" : "sort"](
										m.field, m.direction)
							}
							m = a.group;
							if (k.groupBy) {
...
Ext.grid.GridView = Ext
		.extend(
				Ext.util.Observable,
				{
					...
					doRender : function(d, v, m, a, r, t) {
						...
						for ( var s = 0, w = v.length; s < w; s++) {
							...
							for ( var u = 0; u < r; u++) {
								h = d[u];
								q.id = h.id;
								q.css = u === 0 ? "x-grid3-cell-first "
										: (u == o ? "x-grid3-cell-last " : "");
								q.attr = q.cellAttr = "";
								q.style = h.style;
								q.value = h.renderer.call(h.scope,
										g.data[h.name], q, g, p, u, m);
								if (Ext.isEmpty(q.value)) {
									q.value = "&#160;"
								}
								if (this.markDirty && g.dirty
										&& Ext.isDefined(g.modified[h.name])) {
					...
					renderUI : function() {
						var c = this.templates, e = this.renderHeaders(), a = c.body
								.apply({
									rows : "&#160;"
								});
					...
					processEvent : function(c, i) {
						var d = i.getTarget(), h = this.grid, k = this
								.findHeaderIndex(d);
						h.fireEvent(c, i);
						if (k !== false) {
...
Ext.grid.GridView.SplitDragZone = Ext
		.extend(
				Ext.dd.DDProxy,
				{
					constructor : function(a, b) {
						...
						Ext.grid.GridView.SplitDragZone.superclass.constructor
								.call(this, b, "gridSplitters"
										+ this.grid.getGridEl().id, {
					...
					b4StartDrag : function(a, e) {
						...
						this.marker.show();
						this.marker.alignTo(this.view
								.getHeaderCell(this.cellIndex), "tl-tl", [ -2,
								0 ]);
						this.proxy.setHeight(d);
						var b = this.cm.getColumnWidth(this.cellIndex), c = Math
								.max(b - this.grid.minColumnWidth, 0);
						this.resetConstraints();
					...
					handleMouseDown : function(a) {
						...
						if (i && this.allowHeaderDrag(a)) {
							var l = this.view.fly(i).getXY(), d = l[0], c = l[1], j = a
									.getXY(), b = j[0], h = i.offsetWidth, g = false;
							if ((b - d) <= this.hw) {
								g = -1
							} else {
								if ((d + h) - b <= this.hw) {
					...
					endDrag : function(g) {
						this.marker.hide();
						var a = this.view, c = Math
								.max(this.minX, g.getPageX()), d = c
		...
		.extend(
				Ext.dd.DropZone,
				{
					...
					constructor : function(a, c, b) {
						...
						this.ddGroup = "gridHeader" + this.grid.getGridEl().id;
						Ext.grid.HeaderDropZone.superclass.constructor.call(
								this, a.getGridEl().dom)
					},
					...
					positionIndicator : function(d, k, j) {
						...
						if (this.grid.colModel.isFixed(this.view
								.getCellIndex(k))) {
							return false
						}
					...
					onNodeDrop : function(b, m, g, c) {
						var d = c.header;
						if (d != b) {
							var k = this.grid.colModel, j = Ext.lib.Event
									.getPageX(g), a = Ext.lib.Dom
									.getRegion(b.firstChild), o = (a.right - j) <= ((a.right - a.left) / 2) ? "after"
...
Ext.grid.CheckboxSelectionModel = Ext.extend(Ext.grid.RowSelectionModel, {
	...
	handleMouseDown : function() {
		Ext.grid.CheckboxSelectionModel.superclass.handleMouseDown.apply(this,
				arguments);
					...
					handleKeyDown : function(j) {
						...
						var d = j.getKey(), i = this.grid, p = this.selection, b = this, m = function(
							...
							return i.walkCells(g, c, e,
									i.isEditor && i.editing ? b.acceptsNav
											: b.isSelectable, b)
						}, o, h, a, l, n;
						switch (d) {
						case j.ESC:
				...
				Ext.grid.GridPanel,
				{
					...
					startEditing : function(i, c) {
						...
						if (this.colModel.isCellEditable(c, i)) {
							...
							var d = this.store.getAt(i), h = this.colModel
									.getDataIndex(c), g = {
								grid : this,
								record : d,
								field : h,
							...
							if (this.fireEvent("beforeedit", g) !== false
								...
								b.startEdit(this.view.getCell(i, c).firstChild,
										Ext.isDefined(a) ? a : "");
								(function() {
				...
				Ext.grid.GridView,
				{
					...
					onAdd : function(d, a, b) {
						if (this.canGroup() && !this.ignoreAdd) {
							var c = this.getScrollState();
							this.fireEvent("beforerowsinserted", d, b, b
									+ (a.length - 1));
							this.refresh();
							this.restoreScroll(c);
							this.fireEvent("rowsinserted", d, b, b
									+ (a.length - 1))
						} else {
							if (!this.canGroup()) {
					...
					onGroupByClick : function() {
						...
						this.grid.fireEvent("groupchange", this,
								this.grid.store.getGroupState());
						this.beforeMenuShow();
						this.refresh()
					},
